 ...
 *   <li>{@link caex.caex30.caex.RoleRequirements#getName <em>Name</em>}</li>
 * </ul>
 *
...
public interface RoleRequirements extends CAEXBasicObject {
	 ...
	 * @see #setName(String)
	 * @see caex.caex30.caex.CAEXPackage#getRoleRequirements_Name()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link caex.caex30.caex.RoleRequirements#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
